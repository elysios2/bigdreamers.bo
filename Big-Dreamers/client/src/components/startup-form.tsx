...
export default function StartupForm() {
  ...
  const onSubmit = () => {
    ...
    // Dispara el envío real a FormSubmit
    formRef.current.submit();

    // Muestra toast y estado de éxito
    toast({
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="¿Qué problema resuelves? ¿Cuál es tu propuesta de valor?"
            required
          ></textarea>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            Enlace al Pitch Deck (Drive u otro)
          </label>
          <div
            className={`border-2 border-dashed rounded-lg p-4 text-center ${
              errors.pitchDeck ? "border-red-500 bg-red-50" : "border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-[#048abf]/30"
            }`}
          >
