...
export default function InterestMixed() {
  const features = [
    "Rendimiento con interés mixto",
    "Inversión mínima de 2.000 USD",
    "Una parte de las ganancias se paga y otra se reinvierte",
    "Equilibrio entre liquidez y crecimiento",
    "Mayor flexibilidad de acuerdo a tus objetivos",
    "Acompañamiento y soporte personalizado",
  ];


  const examples = [
    { amount: "2.000 USD", profit: "1.625 USD" },
    { amount: "5.000 USD", profit: "4.063 USD" },
    { amount: "10.000 USD", profit: "8.125 USD" },
  ];
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2 text-gray-800 dark:text-white">
                <span className="text-[#048abf] dark:text-[#feba2b]">Interés</span> Mixto
              </h1>
              <p className="text-gray-600 dark:text-gray-300">
                El sistema que combina lo mejor del interés simple y del compuesto.
              </p>

              <div className="my-6" />
              <p className="text-gray-600 dark:text-gray-300">
                El Interés Mixto te permite recibir una parte de tus ganancias de forma periódica,
                mientras que otra parte se reinvierte automáticamente. De esta manera lográs un
                equilibrio entre liquidez inmediata y crecimiento sostenido del capital.
              </p>

              <div className="my-6" />
              <h3 className="font-semibold text-gray-800 dark:text-white mb-2">
                ¿Por qué elegir Interés Mixto?
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Con una tasa del 2.5 % aplicada de manera combinada, este modelo es ideal para quienes
                desean obtener ingresos sin renunciar al crecimiento progresivo. Es una estrategia
                flexible, pensada para adaptarse a diferentes metas y necesidades.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="neumorph-inset p-6 rounded-xl">
              <ThreeStepForm
                ...
                formSubject="Solicitud Interés Mixto"
