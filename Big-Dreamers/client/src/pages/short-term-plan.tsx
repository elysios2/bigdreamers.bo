...
export default function ShortTermPlan() {
  ...
  const features = [
    "Plazo de 6 meses",
    "Inversión mínima de 5000Bs",
    "Retiro anticipado disponible",
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2 text-gray-800 dark:text-white">
                <span className="text-[#048abf] dark:text-[#feba2b]">Plan </span> Corto Plazo
              </h1>
              <p className="text-gray-600 dark:text-gray-300">
                Tu inversión con retorno rápido y sin complicaciones.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                Si buscás una opción flexible, segura y con liquidez en poco
                tiempo, este plan es ideal para vos. Diseñado para quienes
                quieren ver resultados en el corto plazo sin atarse a largos
                compromisos, te permite invertir de manera inteligente y con
                total control de tu dinero.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                Invertí en el Plan Corto Plazo y disfrutá de una rentabilidad
                del 1.5% mensual durante 6 meses. ¡No esperes más para comenzar
